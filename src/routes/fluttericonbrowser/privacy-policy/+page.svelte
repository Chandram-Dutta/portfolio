<article class="prose lg:prose-xl">
	...
	<p>
		This privacy policy applies to the Flutter Icon Browser app (hereby referred to as
		"Application") for mobile devices that was created by Chandram Dutta (hereby referred to as
	...
	<p>
		...
		(chandramdutta2004@gmail.com) so that they will be able to take the necessary actions. You must
		also be at least 16 years of age to consent to the processing of your personally identifiable
		information in your country (in some countries we may allow your parent or guardian to do so on
		your behalf).
	</p>
	...
	<p>
		...
		the practices, please contact the Service Provider via email at chandramdutta2004@gmail.com.
	</p>
</article>
